export default class Router {
    ...
    get(uri, callback) {
        ...
        if (typeof uri !== "string") throw new TypeError('Type of URI must be a string') // If URI isn't a string
        if (typeof callback !== "function") throw new TypeError('Type of callback must be a function'); // If callback isn't a function.
